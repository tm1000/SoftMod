...
<br>
*quickbar.lua*<br>
save/restore quickbar via chatwire. Exchange strings now use the `M45-QB2` format. Qualities are omitted for normal items and shortened using aliases (`u`, `r`, `e`, `l`) when present (e.g. `iron-plate:l`).<br>
